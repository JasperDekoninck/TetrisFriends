...
class SideBoard:
    def __init__(self, size_per_block, board):
        ...
        self.next_tetrominos = [
            np.random.choice(POSSIBLE_TETROMINOS)([2, 2], self) for _ in range(N_NEXT_BLOCKS)
        ]
    ...
    def get_next_tetromino(self):
        ...
        self.next_tetrominos = self.next_tetrominos[1:] + [np.random.choice(POSSIBLE_BLOCKS)([2, 2], self)]
    ...
    def draw(self, screen, right_top_position_1, left_top_position_2, size_square):
        ...
        self.left_top_position = [right_top_position_1[0] - size_square - 20, right_top_position_1[1] + 10]
